...
todos:
 ...
 convert from R graphs to ggobi screenshots for scatterplot matrices on eg1, eg2 and eg3
 add google analytics links
 add github link to last page
 add youtube link to real normalised page
